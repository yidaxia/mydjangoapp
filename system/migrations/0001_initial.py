# Generated by Django 3.1.3 on 2020-12-03 20:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other', models.JSONField(blank=True, null=True, verbose_name='其他信息')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='system.permission', verbose_name='夫')),
            ],
            options={
                'verbose_name': '功能权限表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('文档', '文档'), ('视频', '视频'), ('音频', '音频'), ('图片', '图片'), ('其他', '其他')], default='文档', max_length=50, verbose_name='文件类型')),
